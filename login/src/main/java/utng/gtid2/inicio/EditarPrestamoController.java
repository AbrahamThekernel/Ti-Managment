...
public class EditarPrestamoController {
    ...
    @FXML
    public void handleBtnActualizar() {

        System.out.println("Actualizando datos del préstamo... Regresando al menú.");
        regresarAlMenu();
    }

    @FXML
    public void handleBtnCancelar() {
        System.out.println("Cancelando edición... Regresando al menú.");
        regresarAlMenu();
    }
